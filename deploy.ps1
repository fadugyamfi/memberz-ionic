...
. ssh -i C:\Users\icewa\.ssh\TG-Personal.pem "runcloud@m.memberz.org" "cd ~/webapps/memberz-ionic; rm -rf ./*.*; cp ~/www.zip ~/webapps/memberz-ionic/www.zip; unzip -o www.zip; exit;"
